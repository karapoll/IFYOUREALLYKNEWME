...
<div id="footer">
  ...
  <?php if (theme_get_setting('social_links', 'phoenix_responsive_theme')): ?>
    <div class="social-icons">
     <ul>
      <li><a class="rss" href="<?php print $front_page; ?>rss.xml" target="_blank"><i class="fa fa-rss"></i></a></li>
  ...
  <?php endif; ?>
    ...
    <div id="copyright">
     <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?> <?php print $site_name; ?> </p> <p class="credits"> <?php print t(''); ?>  <a href="http://www.karimapollinaire.com">Karim Apollinaire</a></p>
    <div class="clear"></div>
    </div>
  </div>
